...
console.log(chalk.italic.bgRedBright("/////////// Welcome to Fariha's IT Coaching Centre. ///////////"));
...
while (condition2 == true) {
    ...
    if (courses.selection === "EXIT") {
        ...
        console.log(chalk.bold.italic.bgRedBright("////////// Good luck for your course. Happy Coding! ///////////"));
    }
}
